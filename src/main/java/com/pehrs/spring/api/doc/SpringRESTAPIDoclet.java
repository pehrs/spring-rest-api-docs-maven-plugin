...
public class SpringRESTAPIDoclet {
	...
	public static final String SYSARG_EXCLUDE_PATTERN = "exclude.pattern";
	public static final String SYSARG_URL_PREFIX = "url.prefix";
	public static final String SYSARG_POM_VERSION = "pom.version";
	public static final String SYSARG_POM_NAME = "pom.name";
	public static final String SYSARG_POM_ARTIFACT_ID = "pom.artifact.id";
	public static final String SYSARG_POM_GROUP_ID = "pom.group.id";
	public static final String SYSARG_TARGET = "target";
	public static final String SYSARG_FILE_EXT = "file.ext";
	public static final String SYSARG_FILE_EXT_DEFAULT = ".html";
	public static final String SYSARG_CLASS_SUFFIX = "class.suffix";
	public static final String SYSARG_CLASS_SUFFIX_DEFAULT = "";
	public static final String SYSARG_CLASS_PREFIX = "class.prefix";
	public static final String SYSARG_CLASS_PREFIX_DEFAULT = "";
	public static final String SYSARG_TEMPLATE_DIR = "template.dir";
